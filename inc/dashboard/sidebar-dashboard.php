<ul class="sts-menu-dashboard">
    <div class="sts-menu-dashboard__top">
        <li class="sts-menu-dashboard__item">
            <a class="sts-menu-dashboard__item__link active" href="#">Mi perfil</a>
        </li>
        <li class="sts-menu-dashboard__item">
            <a class="sts-menu-dashboard__item__link" href="#">Personal Records</a>
        </li>

        <li class="sts-menu-dashboard__item">
            <a class="sts-menu-dashboard__item__link" href="#">
                Mis planes
        ...
        <li class="sts-menu-dashboard__item">
            <a class="sts-menu-dashboard__item__link" href="#">Estadísticas</a>
        </li>
    </div>

    <div class="sts-menu-dashboard__bottom">
        <li class="sts-menu-dashboard__item">
            <a class="sts-menu-dashboard__item__link" href="#">Item</a>
        </li>
    </div>
</ul>